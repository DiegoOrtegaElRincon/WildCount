...
const Startup = () => {
    ...
    return (
        <div className='h-[100vh] relative'>
            ...
            <span id='left-line' className='bg-black h-[2rem] w-[50vw] absolute top-[57.5%] -translate-y-1/2 left-0'></span>
            ...
            <span id='right-line' className='bg-black h-[2rem] w-[50vw] absolute top-[42.5%] -translate-y-1/2 right-0'></span>
